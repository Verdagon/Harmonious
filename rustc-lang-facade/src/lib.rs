...
static DEFAULT_DEDUCED_PARAM_ATTRS: OnceLock<queries::deduce_param_attrs::DeducedParamAttrsFn>
    = OnceLock::new();
// DEFAULT_CODEGEN_FN_ATTRS retired 2026-06-25 (Phase Q retirement; see
// `queries/mod.rs` header note).
...
// `default_codegen_fn_attrs` accessor retired 2026-06-25 (Phase Q
// retirement; see `queries/mod.rs` header note).
