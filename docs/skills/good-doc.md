...
5. **Architecture** — Internal design, data flow, invariants for modifying the feature itself.
6. **Reasoning** — Why the current approach was chosen over alternatives. Sub-category of architecture.
